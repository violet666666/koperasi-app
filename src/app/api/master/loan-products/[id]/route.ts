    ...
    try {
        ...
        const updated = await prisma.loanProduct.update({
            ...
            data: {
                ...
                ...(body.maxTenor !== undefined && { maxTenor: body.maxTenor }),
                ...(body.adminFeePercent !== undefined && { adminFeePercent: body.adminFeePercent }),
                ...(body.riskFundPercent !== undefined && { riskFundPercent: body.riskFundPercent }),
