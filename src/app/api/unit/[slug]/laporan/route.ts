...
export async function GET(
    ...
    try {
        ...
        // Untuk unit F&B (usesStoreSales): record piutang auto-generated
        // (UTG, semua prefix unit) di-exclude SETELAH fetch via
        // isAutoGeneratedPiutang() — angka tsb sudah tercatat di StoreSale,
        // kalau tidak di-exclude nominal Potong Gaji terhitung ganda.
        ...
        // NOTE: piutang auto-generated (UTG) di-exclude SETELAH fetch via
        // isAutoGeneratedPiutang() — lihat bawah. Filter prefix transactionNo
        // (TK-UTG-/MB-UTG-) dulu dipakai di level DB tapi terlalu sempit:
        // lolos RS-UTG-/CF-UTG-/RC-UTG-/CL-UTG-/PS-UTG- → duplikat Potong Gaji
        // di laporan Resto & Cafe LSP (bug 2026-06-28).
        ...
        // Pure predicate = single source of truth; menangkap SEMUA prefix unit
        // (TK/RS/RC/CF/CL/PS) + mobile, konsisten dgn riwayat route + 5 route lain.
        // Tanpa ini, nominal Potong Gaji terhitung ganda di totalPendapatan/laba.
        if (usesStoreSales) {
