...
export default function CafeLspModifiersAdminPage() {
    ...
    return (
        <div className="space-y-6">
            <PageHeader
                ...
                description="Kelola opsi modifier per menu (tingkat pedas, tambah topping, ukuran, dll)"
                actions={
                ...
                <Card className="lg:max-h-[700px] lg:overflow-hidden">
                    <CardContent className="p-3 sm:p-4">
                        ...
                        <div className="flex lg:flex-col gap-2 overflow-x-auto lg:overflow-x-visible lg:overflow-y-auto lg:max-h-[600px] pb-2 lg:pb-0">
                            ...
                            {products.length === 0 && (
                                <p className="text-sm text-slate-400 text-center py-8">Belum ada menu. Tambah menu terlebih dahulu.</p>
                            )}
                        </div>
                    </CardContent>
                </Card>
                    ...
                    {!selectedProduct ? (
                        <Card>
                            <CardContent className="flex flex-col items-center justify-center py-16 text-slate-400">
                                ...
                                <p className="font-medium">Pilih menu untuk mengatur modifier</p>
                            </CardContent>
                        </Card>
                    ) : (
                        <>
